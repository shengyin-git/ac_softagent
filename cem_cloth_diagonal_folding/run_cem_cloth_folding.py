...
def main():
    ...
    parser.add_argument('--env_name', default='ClothDiagonalFold') 
    ...
    # key_point_idx = get_rand_int(low=0, high=8100, size=4)
    # key_point_idx = get_rand_edge_idx(width= 90, height = 90, size = 4)
    print(key_point_idx)
