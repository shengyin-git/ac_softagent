...
def main():
    ...
    parser.add_argument('--env_kwargs_horizon', default=20, type=int)
    parser.add_argument('--env_kwargs_action_repeat', default=2, type=int) 
    ...
    # key_point_idx = None
    key_point_idx = get_rope_key_point_idx(parser)
    # key_point_idx = get_rand_int(low=0, high=40, size=2)
