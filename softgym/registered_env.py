...
from softgym.envs.rope_fold import RopeFoldEnv
...
from softgym.envs.cloth_reflective_fold import ClothReflectiveFoldEnv
from softgym.envs.cloth_underneath_fold import ClothUnderneathFoldEnv
...
env_arg_dict = {
    ...
    'RopeConfiguration': {'observation_mode': 'cam_rgb',
                          ...
                          'use_cached_states': True,
                          'deterministic': False},
    'RopeFold': {'observation_mode': 'cam_rgb',
                          'action_mode': 'picker',
                          'num_picker': 2,
                          'render': True,
                          'headless': True,
    ...
    'ClothFold': {'observation_mode': 'cam_rgb',
                  ...
                  'use_cached_states': True,
                  'deterministic': False},
    'ClothDiagonalFold': {'observation_mode': 'cam_rgb',
                  'action_mode': 'picker',
                  'num_picker': 2,
                  'render': True,
                  'headless': True,
                  ...
                  'use_cached_states': True,
                  'deterministic': False},
    'ClothSideFold': {'observation_mode': 'cam_rgb',
                  'action_mode': 'picker',
                  'num_picker': 2,
                  'render': True,
                  'headless': True,
                  ...
                  'use_cached_states': True,
                  'deterministic': False},
    'ClothReflectiveFold': {'observation_mode': 'cam_rgb',
                  'action_mode': 'picker',
                  'num_picker': 2,
                  'render': True,
                  'headless': True,
                  ...
                  'use_cached_states': True,
                  'deterministic': False},
    'ClothUnderneathFold': {'observation_mode': 'cam_rgb',
                  'action_mode': 'picker',
                  'num_picker': 2,
                  'render': True,
                  'headless': True,
...
SOFTGYM_ENVS = OrderedDict({
    ...
    'ClothReflectiveFold': ClothReflectiveFoldEnv,
    'ClothUnderneathFold': ClothUnderneathFoldEnv,
