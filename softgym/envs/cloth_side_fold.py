...
class ClothSideFoldEnv(ClothEnv):
    def __init__(self, key_point_idx=None, cached_states_path='cloth_side_fold_init_states.pkl', **kwargs):
    ...
    def generate_env_variation(self, num_variations=2, vary_cloth_size=True):
        ...
        for i in range(num_variations):
            ...
            center_object()
            angle = 0 #(np.random.random() - 0.5) * np.pi / 2
